...
const AdminSidebar = ({
  ...
  return (
    <>
      ...
      <aside
        className={`fixed top-0 left-0 rtl:right-0 rtl:left-auto h-full bg-white dark:bg-[#1a1a1a] border-r rtl:border-l rtl:border-r-0 border-yellow-500/20 z-50 transition-all duration-300 ${
