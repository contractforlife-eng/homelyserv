  ...
  return (
    <div className={`relative ${className}`}>
      ...
      {isOpen && (
        <div
          ref={dropdownRef}
          className="fixed left-3 right-3 top-14 z-50 w-auto max-w-none max-h-[calc(100dvh-8rem)] sm:absolute sm:left-auto sm:right-0 sm:rtl:right-auto sm:rtl:left-0 sm:mt-2 sm:w-96 sm:max-w-96 sm:max-h-[500px] bg-white rounded-xl shadow-2xl border border-gray-200 overflow-hidden"
        >
          {/* Header */}
