...
const RELEASE_MANIFEST_URL = '/downloads/android/1.0.22-23/release.json';
const FALLBACK_DOWNLOAD_URL = 'https://github.com/contractforlife-eng/homelyserv/releases/download/v1.0.22/HomelyServ-1.0.22-23.apk';
const FALLBACK_RELEASE = {
  ...
  sha256: '28E6AE4ED4A9CB6DEA5EA8C917C50C755F83F27233BE41A874DAF212F1AA4695',
      ...
      <section className="relative overflow-hidden bg-gradient-to-br from-red-700 via-red-600 to-rose-600 px-5 pb-16 pt-10 text-white sm:px-8 sm:pt-14">
        ...
        <div className="relative mx-auto grid max-w-6xl items-center gap-10 lg:grid-cols-[1.15fr_0.85fr]">
          <div>
            ...
            <h1 className="max-w-2xl text-4xl font-black tracking-tight text-cyan-100 sm:text-6xl">
