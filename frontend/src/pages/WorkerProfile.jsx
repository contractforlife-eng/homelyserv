...
import { Star, MapPin, DollarSign, Briefcase, Calendar, Clock, CheckCircle, MessageCircle, Shield, Award, Mail, Phone } from 'lucide-react';
...
function WorkerProfile() {
  ...
  const worker = {
    ...
    bio: 'Experienced nanny with 5 years of experience. Passionate about childcare and child development. I have worked with children of all ages from newborns to teenagers.',
