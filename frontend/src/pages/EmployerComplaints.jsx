                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    ...
                    <input
                      ...
                      className="w-full px-4 py-2.5 border border-gray-200 dark:border-gray-700 rounded-lg focus:ring-2 focus:ring-teal-500 focus:border-transparent"
                      required
                    />
                  </div>
                  <div>
            ...
            <div className="flex flex-col md:flex-row gap-4">
              ...
              <div className="flex flex-wrap gap-2">
                <select
                  ...
                  className="px-4 py-2.5 border border-gray-200 dark:border-gray-700 rounded-lg focus:outline-none focus:ring-2 focus:ring-teal-500 bg-white dark:bg-gray-800 text-gray-700 dark:text-gray-300"
                >
                      ...
                      <div className="flex flex-wrap items-center gap-2">
                        {complaint.adminResponse && (
                          <button
                            ...
                            className="px-3 py-1.5 bg-teal-50 dark:bg-teal-900/30 text-teal-600 rounded-lg text-sm font-medium hover:bg-teal-100 transition flex items-center gap-1"
                          >
