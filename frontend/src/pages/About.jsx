    ...
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900">
      ...
      <div className="max-w-6xl mx-auto px-6 py-8">
        ...
        <div className="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-100 dark:border-gray-700 p-8">
          <h2 className="text-2xl font-bold text-gray-800 dark:text-white mb-4">Why Choose HomelyServ?</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="flex items-start gap-3">
              <CheckCircle size={20} className="text-green-500 mt-1 flex-shrink-0" />
              <div>
                <p className="font-medium text-gray-800 dark:text-white">Verified Professionals</p>
                <p className="text-sm text-gray-500 dark:text-gray-400 dark:text-gray-500">All workers are identity verified and background checked</p>
              </div>
            </div>
            <div className="flex items-start gap-3">
              <CheckCircle size={20} className="text-green-500 mt-1 flex-shrink-0" />
              <div>
                <p className="font-medium text-gray-800 dark:text-white">Secure Payments</p>
                <p className="text-sm text-gray-500 dark:text-gray-400 dark:text-gray-500">Multiple payment methods with secure processing</p>
              </div>
            </div>
            <div className="flex items-start gap-3">
              <CheckCircle size={20} className="text-green-500 mt-1 flex-shrink-0" />
              <div>
                <p className="font-medium text-gray-800 dark:text-white">Real-time Chat</p>
                <p className="text-sm text-gray-500 dark:text-gray-400 dark:text-gray-500">Communicate directly with workers and employers</p>
              </div>
            </div>
            <div className="flex items-start gap-3">
              <CheckCircle size={20} className="text-green-500 mt-1 flex-shrink-0" />
              <div>
                <p className="font-medium text-gray-800 dark:text-white">24/7 Support</p>
                <p className="text-sm text-gray-500 dark:text-gray-400 dark:text-gray-500">Our team is always here to help you</p>
              </div>
            </div>
          </div>
        </div>
