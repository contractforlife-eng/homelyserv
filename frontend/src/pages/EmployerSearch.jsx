...
const EmployerSearch = () => {
  ...
  const getWorkerDisplayLocation = (worker) => {
    if (!worker) return 'Not specified';
    return (
          ...
          <div className="flex flex-col gap-4">
            ...
            {showResults && (
              <div className="text-sm text-teal-100">
                {searchResults.length} {t.workersAvailable}
              </div>
            )}
          </div>
        </div>
        ...
        <div className="bg-white dark:bg-gray-800 rounded-xl shadow-sm p-4 border border-gray-100 dark:border-gray-700 mb-6">
          <div className="flex flex-col lg:flex-row gap-3">
            ...
            <div className="flex-1">
              <label className="block text-xs font-medium text-gray-600 dark:text-gray-400 mb-1.5">{t.jobType}</label>
              <select
                value={selectedJob}
            ...
            {/* Location Filter */}
            <div className="flex-1">
              <label className="block text-xs font-medium text-gray-600 dark:text-gray-400 mb-1.5">{t.location}</label>
              <select
            ...
            <div className="w-full lg:w-48">
              <label className="block text-xs font-medium text-gray-600 dark:text-gray-400 mb-1.5">{t.minExperience}</label>
              <select
            ...
            {/* Max Hourly Rate */}
            <div className="w-full lg:w-48">
              <label className="block text-xs font-medium text-gray-600 dark:text-gray-400 mb-1.5">{t.maxHourlyRate}</label>
              <input
                type="range"
                min="10"
              ...
              <div className="text-xs text-center text-gray-500 dark:text-gray-400 mt-1">
                {advancedFilters.maxHourlyRate} EGP
              </div>
            </div>

            {/* Availability */}
            <div className="w-full lg:w-40">
              <label className="block text-xs font-medium text-gray-600 dark:text-gray-400 mb-1.5">{t.availability}</label>
              <select
          ...
          <div className="mt-3 pt-3 border-t border-gray-200 dark:border-gray-700">
            ...
            {showFilters && (
              <div className="mt-4 grid grid-cols-1 md:grid-cols-3 gap-3">
                <div>
                  <label className="block text-xs font-medium text-gray-600 dark:text-gray-400 mb-1.5">{t.minRating}</label>
                  <select
                ...
                <div>
                  <label className="block text-xs font-medium text-gray-600 dark:text-gray-400 mb-1.5">{t.language}</label>
                  <select
                ...
                <div>
                  <label className="block text-xs font-medium text-gray-600 dark:text-gray-400 mb-1.5">{t.sortBy}</label>
                  <select
                    value={sortBy}
