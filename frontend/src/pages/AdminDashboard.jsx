...
import { 
  ...
  Shield, Award, Zap, Activity, PieChart, LineChart
} from 'lucide-react';
    ...
    <div className="min-h-screen bg-gray-50 flex">
      ...
      <div className="flex-1 overflow-y-auto">
        ...
        <div className="p-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="flex justify-between items-center">
                      <span className="text-sm text-gray-800">Security</span>
                      <span className="text-sm font-medium">285 (9%)</span>
                    </div>
                    <div className="w-full bg-gray-200 rounded-full h-2">
                      <div className="bg-purple-600 h-2 rounded-full" style={{ width: '9%' }}></div>
                    </div>
                    <div className="flex justify-between items-center">
                      <span className="text-sm text-gray-800">Housekeeping</span>
                      <span className="text-sm font-medium">220 (7%)</span>
                    </div>
                    <div className="w-full bg-gray-200 rounded-full h-2">
          ...
          {activeTab === 'workers' && (
            <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
              <h3 className="text-xl font-bold text-gray-800 mb-4">Worker Management</h3>
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                <div className="border border-gray-200 rounded-lg p-4">
                  <div className="flex items-center gap-3">
                    <img src="https://images.unsplash.com/photo-1589571894960-20bbe2828c42?w=50&h=50&fit=crop&crop=face" alt="Worker" className="w-12 h-12 rounded-full object-cover" />
                    <div>
                      <p className="font-semibold text-gray-800">Ahmed Ali</p>
                      <p className="text-xs text-gray-500">Nanny • 4.9 ★</p>
                    </div>
                  </div>
                  <div className="mt-2 flex gap-2">
                    <button className="flex-1 px-2 py-1 bg-blue-100 text-blue-700 rounded text-xs">Verify</button>
                    <button className="flex-1 px-2 py-1 bg-red-100 text-red-700 rounded text-xs">Suspend</button>
                  </div>
                </div>
                <div className="border border-gray-200 rounded-lg p-4">
                  <div className="flex items-center gap-3">
                    <img src="https://images.unsplash.com/photo-1593104547489-5cfb3839a3b5?w=50&h=50&fit=crop&crop=face" alt="Worker" className="w-12 h-12 rounded-full object-cover" />
                    <div>
                      <p className="font-semibold text-gray-800">Mona Hassan</p>
                      <p className="text-xs text-gray-500">Caregiver • 4.8 ★</p>
                    </div>
                  </div>
                  <div className="mt-2 flex gap-2">
                    <button className="flex-1 px-2 py-1 bg-blue-100 text-blue-700 rounded text-xs">Verify</button>
          ...
          {activeTab === 'jobs' && (
            <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
              <h3 className="text-xl font-bold text-gray-800 mb-4">Job Management</h3>
              <div className="space-y-3">
                <div className="border border-gray-200 rounded-lg p-4 flex justify-between items-center">
                  <div>
                    <p className="font-semibold text-gray-800">Need a babysitter for 2 kids</p>
                    <p className="text-sm text-gray-500">New York, USA • Posted 2 days ago</p>
                  </div>
                  <span className="px-3 py-1 bg-yellow-100 text-yellow-800 rounded-full text-sm">Pending</span>
                </div>
                <div className="border border-gray-200 rounded-lg p-4 flex justify-between items-center">
                  <div>
                    <p className="font-semibold text-gray-800">Elderly care for my father</p>
                    <p className="text-sm text-gray-500">Los Angeles, USA • Posted 5 days ago</p>
                  </div>
          ...
          {activeTab === 'payments' && (
            <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
              ...
              <div className="space-y-3">
                <div className="border border-gray-200 rounded-lg p-4 flex justify-between items-center">
                  <div>
                    <p className="font-semibold text-gray-800">Babysitter Service</p>
                    <p className="text-sm text-gray-500">Transaction #HS-2026-0001</p>
                  </div>
                  <div className="flex items-center gap-4">
                ...
                <div className="border border-gray-200 rounded-lg p-4 flex justify-between items-center">
                  <div>
                    <p className="font-semibold text-gray-800">Driver Service</p>
                    <p className="text-sm text-gray-500">Transaction #HS-2026-0002</p>
                  </div>
                  <div className="flex items-center gap-4">
            ...
            <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
              ...
              <div className="space-y-3">
                <div className="border border-gray-200 rounded-lg p-4">
                  <div className="flex justify-between items-start">
                    <div>
                      ...
                      <p className="text-sm text-gray-500 mt-1">"Excellent nanny! Highly recommended."</p>
                    </div>
                ...
                <div className="border border-gray-200 rounded-lg p-4">
                  <div className="flex justify-between items-start">
                    <div>
                      <p className="font-semibold text-gray-800">Khaled Rashed</p>
                      <div className="flex items-center gap-1 mt-1">
                        <Star size={16} className="fill-yellow-400 text-yellow-400" />
                        <span className="text-sm">4.0</span>
                      </div>
                      <p className="text-sm text-gray-500 mt-1">"Great with children, very reliable."</p>
                    </div>
            ...
            <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
              ...
              <div className="space-y-4">
                <div className="border border-gray-200 rounded-lg p-4">
                  ...
                  <button className="mt-2 px-4 py-2 bg-red-600 text-white rounded-lg text-sm hover:bg-red-700">Edit</button>
                </div>
                <div className="border border-gray-200 rounded-lg p-4">
                  ...
                  <button className="mt-2 px-4 py-2 bg-red-600 text-white rounded-lg text-sm hover:bg-red-700">Manage</button>
                </div>
              </div>
            </div>
          )}
