    ...
    <Layout activeTab="admin">
      ...
      <div className="stats-grid">
        <div className="stat-card" style={{ background: 'linear-gradient(135deg, #e8f5e9, #c8e6c9)' }}>
          ...
          <div className="stat-change">👥 {stats.workers} Workers · {stats.employers} Employers</div>
        </div>
      ...
      <div className="card-grid card-grid-4">
        ...
        >
          ...
          <h4 style={{ fontSize: '14px', fontWeight: '600', color: '#1a3a1a' }}>User Management</h4>
          <p style={{ fontSize: '12px', color: '#5a7a5a' }}>Manage all registered users</p>
          <span style={{ fontSize: '12px', color: '#2e7d32', fontWeight: '600' }}>View Users →</span>
        </div>
        <div 
          className="card" 
          style={{ cursor: 'pointer', textAlign: 'center' }}
        ...
        >
          <div style={{ fontSize: '32px', marginBottom: '8px' }}>📋</div>
          <h4 style={{ fontSize: '14px', fontWeight: '600', color: '#1a3a1a' }}>Hire Management</h4>
          <p style={{ fontSize: '12px', color: '#5a7a5a' }}>View and manage all hires</p>
          <span style={{ fontSize: '12px', color: '#2e7d32', fontWeight: '600' }}>View Hires →</span>
        </div>
        <div 
          className="card" 
          style={{ cursor: 'pointer', textAlign: 'center' }}
        ...
        >
          <div style={{ fontSize: '32px', marginBottom: '8px' }}>💰</div>
          <h4 style={{ fontSize: '14px', fontWeight: '600', color: '#1a3a1a' }}>Payment Tracking</h4>
          <p style={{ fontSize: '12px', color: '#5a7a5a' }}>Monitor all payments and commissions</p>
          <span style={{ fontSize: '12px', color: '#2e7d32', fontWeight: '600' }}>View Payments →</span>
        </div>
        <div 
          className="card" 
          style={{ cursor: 'pointer', textAlign: 'center' }}
        ...
        >
          <div style={{ fontSize: '32px', marginBottom: '8px' }}>📊</div>
          <h4 style={{ fontSize: '14px', fontWeight: '600', color: '#1a3a1a' }}>Revenue Reports</h4>
          <p style={{ fontSize: '12px', color: '#5a7a5a' }}>View platform revenue and statistics</p>
          <span style={{ fontSize: '12px', color: '#2e7d32', fontWeight: '600' }}>View Reports →</span>
        </div>
      </div>
      ...
      <div className="card" style={{ padding: '24px', minHeight: '300px' }}>
          ...
          <div>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '16px' }}>
              <div>
                ...
                <div style={{ padding: '12px', background: '#f8fbf8', borderRadius: '8px', marginBottom: '8px' }}>
                  <span style={{ color: '#5a7a5a' }}>Workers:</span> <strong>{stats.workers}</strong>
                </div>
                <div style={{ padding: '12px', background: '#f8fbf8', borderRadius: '8px', marginBottom: '8px' }}>
                  <span style={{ color: '#5a7a5a' }}>Employers:</span> <strong>{stats.employers}</strong>
                </div>
                <div style={{ padding: '12px', background: '#f8fbf8', borderRadius: '8px' }}>
                  <span style={{ color: '#5a7a5a' }}>Admins:</span> <strong>{stats.admins}</strong>
                </div>
              </div>
              <div>
                <div style={{ padding: '12px', background: '#f8fbf8', borderRadius: '8px', marginBottom: '8px' }}>
        ...
        {activeTab === 'users' && (
          <div>
            <h3 style={{ fontSize: '18px', fontWeight: '600', color: '#1a3a1a', marginBottom: '16px' }}>👥 All Users ({users.length})</h3>
            {users.length === 0 ? (
          ...
          <div>
            ...
            {hires.length === 0 ? (
              <div style={{ textAlign: 'center', padding: '40px', color: '#5a7a5a' }}>
                ...
                <p style={{ color: '#5a7a5a' }}>Click "Create Test Data" to generate sample data.</p>
              </div>
            ) : (
              <div style={{ overflowX: 'auto' }}>
                <table style={{ width: '100%', borderCollapse: 'collapse', fontSize: '14px' }}>
