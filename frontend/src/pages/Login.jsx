...
export default function Login() {
  ...
  return (
    <div style={{ minHeight: '100vh', background: '#F5F5F5', display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '20px' }}>
      <div style={{ background: '#fff', borderRadius: '12px', padding: '32px', width: '100%', maxWidth: '400px', boxShadow: '0 2px 12px rgba(0,0,0,0.08)', position: 'relative' }}>
        ...
        <div style={{ textAlign: 'center', marginBottom: '28px' }}>
          ...
          <p style={{ color: '#888', marginTop: '4px' }}>{t('sign_in_to_account')}</p>
        </div>
        ...
        <p style={{ textAlign: 'center', fontSize: '13px', color: '#888', marginTop: '16px' }}>
          {t('dont_have_account')} <Link to="/register" style={{ color: '#C0392B', fontWeight: '500' }}>{t('create_one')}</Link>
        </p>
      </div>
    </div>
  );
