    ...
    <div className="min-h-screen flex items-center justify-center bg-gray-50 px-4">
      <div className="w-full max-w-sm">
        ...
        <div className="text-center mb-6">
          <span className="text-sm font-medium text-gray-700">8:00</span>
        </div>
        ...
        <div className="flex items-center my-6">
          ...
          <span className="px-4 text-sm text-gray-400">أو سجل عبر:</span>
          <div className="flex-1 border-t border-gray-300"></div>
        </div>
        ...
        <div className="flex justify-center gap-4">
          ...
          <button className="px-4 py-2 border border-gray-300 rounded-lg hover:bg-gray-50 transition text-sm text-gray-600">
            Facebook
          </button>
        </div>
      </div>
