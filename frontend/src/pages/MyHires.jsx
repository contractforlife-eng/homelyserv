...
import { Search, Filter, Eye, MessageCircle, DollarSign, CheckCircle, XCircle, Clock, User, MapPin, Star } from 'lucide-react';
              ...
              <div className="flex items-start gap-4">
                ...
                <div className="flex-1">
                  ...
                  <div className="flex items-center gap-2 mt-1">
                    ...
                    <span className="text-sm text-gray-500">{hire.location}</span>
                  </div>
                </div>
              </div>
